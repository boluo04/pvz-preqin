...
PLANT_CARD_INFO = (  # 元组 (植物名称, 卡片名称, 阳光, 冷却时间)
    ...
    (
        BINGYONG_WALLNUT := 'BingYongWallNut',
        CARD_BINGYONG_WALLNUT := 'card_bingyongwallnut',
        100,
        30000,
    ),
    (
    ...
    (
        BAIQI_CHERRYBOMB := 'BaiQiCherryBomb',
        CARD_BAIQI_CHERRYBOMB := 'card_baiqicherrybomb',
        300,
        125000,
    ),
